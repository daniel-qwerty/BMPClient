...
open class BPMClientAPI {
    open static var basePath = "https://bpm-backend.saritasa-hosting.com/api/v1"
...
open class RequestBuilder<T> {
    ...
    required public init(method: String, URLString: String, parameters: [String:Any]?, isBody: Bool) {
        ...
        addHeaders(BPMClientAPI.customHeaders)
    }
    ...
    open func addCredential() -> Self {
        self.credential = BPMClientAPI.credential
        return self
    }
}
